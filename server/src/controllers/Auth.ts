...
export const sendotp = async (req: Request, res: Response): Promise<void | Response> => {
  try {
...
export const changePassword = async (req: CustomRequest, res: Response): Promise<void | Response> => {
  try {
